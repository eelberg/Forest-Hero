...
// Pon 'png' si añades en public/img/ tus archivos: princess_captive.png, dragon_feast.png, death_with_princess.png, victory.png
const STORY_IMG_EXT = 'png';

function storyImg(baseName) {
    return publicImg(`${baseName}.${STORY_IMG_EXT}`);
}
    ...
    if (ending === 'death_without_princess') {
        sceneHtml = `
            <div class="feast-scene">
                <img src="${storyImg('dragon_feast')}" alt="El dragón devora a la princesa" class="feast-image">
        ...
        sceneHtml = `
            <div class="feast-scene">
                <img src="${storyImg('death_with_princess')}" alt="El héroe y la princesa yacen muertos en el bosque" class="feast-image">
        ...
        sceneHtml = `
            <div class="feast-scene victory-scene">
                <img src="${storyImg('victory')}" alt="El rey ordena caballero al héroe" class="feast-image">
    ...
    elements.welcomeScreen.innerHTML = `
        <div class="welcome-content">
            ...
            <div class="start-image-container">
                <img src="${storyImg('princess_captive')}" alt="La princesa cautiva por el hechicero y su dragón" class="start-image">
            </div>
